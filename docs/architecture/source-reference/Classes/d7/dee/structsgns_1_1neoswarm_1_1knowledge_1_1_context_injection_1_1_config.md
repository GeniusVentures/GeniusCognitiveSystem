---
title: sgns::neoswarm::knowledge::ContextInjection::Config

---

# sgns::neoswarm::knowledge::ContextInjection::Config
...
max tokens to add for context 

### variable add_source_tags_

```cpp
bool add_source_tags_ = true;
```

add [GROKIPEDIA: source] tags 
