...
### 2.1 Why zk is out of scope at the GCS layer
...
### 2.2 The lazy-node / model-substitution attack
...
### 4.2 Class A - Reference-integer semantics
...
### 4.3 Class B - Bounded-drift semantics
...
### 4.4 Class C - Non-deterministic paths
...
### 4.5 Constraints on kernel authors
...
## 5. Checkpoint-Band Matching

### 5.1 Checkpoints, not per-op comparison
...
### 5.3 Registration invariant: the band forgives hardware, not weights
...
### 5.4 Calibration and drift monitoring
...
## 6. Teacher-Forced Spot-Check Protocol

### 6.1 The autoregressive divergence problem
...
### 6.4 Sampling-consistency check
...
## 7. Interaction with Semantic Consensus
...
## 8. Interaction with GAML and Cognitive Assets
