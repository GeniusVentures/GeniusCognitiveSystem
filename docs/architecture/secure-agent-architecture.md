...
##### 18.1.2.2.1 Node colocation rules
...
##### 18.1.2.2.2 Trust tiers for node roles
...
#### 18.1.3.1 Router and Planner Service (Query -> Execution Graph)

##### 18.1.3.1.1 Responsibilities
...
##### 18.1.3.1.4 Execution plan schema
...
##### 18.1.3.1.5 Routing algorithm (conceptual pseudocode)
...
##### 18.1.3.2.3 Expert output package schema
...
##### 18.1.3.2.4 Expert packaging and runtime rules
...
##### 18.1.3.2.5 Capability manifest format
...
##### 18.1.3.2.6 Tool proposals are proposals only
...
#### 18.1.3.3 Verification, Arbitration, and Synthesis Service

##### 18.1.3.3.1 Responsibilities
...
##### 18.1.3.3.4 Aggregation logic pseudocode
...
#### 18.1.3.4 Structured Memory Service

##### 18.1.3.4.1 Responsibilities
...
##### 18.1.3.4.3 Higher-trust memory definition
...
##### 18.1.3.4.4 Lower-trust memory definition
...
##### 18.1.3.4.7 Replication rule change
...
##### 18.1.3.4.8 Memory event schema
...
#### 18.1.3.5 Grounding Service

##### 18.1.3.5.1 Responsibilities
...
#### 18.1.3.7 Privacy and Secure Collaboration

##### 18.1.3.7.1 Responsibilities
...
##### 18.1.3.7.2 Privacy attachment points
...
#### 18.1.3.8 Tool Intermediary Service
...
##### 18.1.3.8.5 Dry-run result schema
...
##### 18.1.3.8.7 Sanitized data schema
...
##### 18.1.3.8.8 Deterministic dry-run logic pseudocode
...
##### 18.1.3.8.9 Instruction scrubber pseudocode
...
##### 18.1.3.8.10 Trap detection categories
...
##### 18.1.3.8.11 Human approval gating policy
...
##### 18.1.3.8.12 Real execution after approval
...
##### 18.1.3.8.13 Zero-trust sandbox rules
...
#### 18.1.4.1 Primary inference flow (user query)
...
##### 18.1.4.1.1 Detailed sequence notes
...
#### 18.1.4.2 Learning flow (post-task improvement)
...
##### 18.1.4.2.1 Learning flow security note
...
#### 18.1.5.1 Agent service contracts
...
#### 18.1.5.2 Processing definitions
...
##### 18.1.5.2.1 Updated processing schema entries
...
##### 18.1.5.2.2 Example ToolProposal schema
...
##### 18.1.5.2.3 Example ToolAttestation schema
...
##### 18.1.6.1.1 Tool Intermediary fault handling
...
##### 18.1.6.2.1 Additional safety gates
...
#### 18.1.8.1 Minimum events to log per task
...
#### 18.1.8.2 Primary dashboard metrics
...
#### 18.1.8.3 Recommended alerting thresholds
...
#### 18.1.10.1 Why tool proposals must be indirect
...
#### 18.1.10.2 Why higher-trust and lower-trust memory must be separated
...
#### 18.1.10.3 Why constrained execution packaging is preferable for specialist logic
...
#### 18.1.10.4 Recommended first implementation order
