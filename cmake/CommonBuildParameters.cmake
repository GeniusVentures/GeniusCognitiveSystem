...
# GeniusSDK is linked statically (sgns::GeniusSDK, thin wrapper over the sgns::*
# archives — it embeds none of the SuperGenius stack). The former CI-6 Linux
# redirect of every sgns::* archive to libGeniusSDK_shared.so was removed with it:
# it mixed the .so with the static archives and resolved to NOTFOUND in Release
# configs. GCS_SDK_SINGLE_PROVIDER is no longer set (see git history, commit 29084c0).
